...
public class CustomerServiceImpl implements CustomerService, UserDetailsService {
  ...
  public CustomerDto getCustomerProfile(Long id) {
    Customer customer =
        customerRepository
            .findById(id)
            .orElseThrow(
                () -> CommonUtils.logAndGetException("Customer not found with email: " + id));
  ...
  public CustomerDto updateCustomerProfile(Long id, CustomerDto customerDto) {
    ...
    customer.setName(
        Objects.nonNull(customerDto.getName()) ? customerDto.getName() : customer.getName());
    customer.setPhone(
        Objects.nonNull(customerDto.getPhone()) ? customerDto.getPhone() : customer.getPhone());
    customer.setEmail(
        Objects.nonNull(customerDto.getEmail()) ? customerDto.getEmail() : customer.getEmail());
    customer.setAddress(
        Objects.nonNull(customerDto.getAddress())
  ...
  public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
    Customer customer =
        customerRepository
            .findByEmail(email)
            .orElseThrow(
                () -> CommonUtils.logAndGetException("User not found with email: " + email));
  ...
  public void disableCustomer(Long customerId) {
    Customer customer =
        customerRepository
            .findById(customerId)
            .orElseThrow(
                () -> CommonUtils.logAndGetException("Customer not found with ID: " + customerId));
