  ...
  public ProductDto updateProduct(Long productId, ProductDto productDto) {
    Product product =
        productRepository
            .findById(productId)
            .orElseThrow(
                () -> CommonUtils.logAndGetException("Product not found with ID: " + productId));

    product.setName(
        Objects.nonNull(productDto.getName()) ? productDto.getName() : product.getName());
    product.setDescription(
        Objects.nonNull(productDto.getDescription())
            ? productDto.getDescription()
            : product.getDescription());
    product.setPrice(
        Objects.nonNull(productDto.getPrice()) ? productDto.getPrice() : product.getPrice());
    product.setImageUrl(
        Objects.nonNull(productDto.getImageUrl())
            ? productDto.getImageUrl()
            : product.getImageUrl());
    product.setStockQuantity(
        Objects.nonNull(productDto.getStockQuantity())
