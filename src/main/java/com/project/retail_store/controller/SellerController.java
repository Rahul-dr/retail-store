...
public class SellerController {
    ...
    public ApiResponse<SellerDto> addSeller(
        ...
        return new ApiResponse<>("Seller added successfully", 
                sellerService.addSeller(sellerDto, userDetails.getUsername()));
    }
    
    @GetMapping
    public ApiResponse<List<SellerDto>> getAllSellers() {
        return new ApiResponse<>("Sellers retrieved successfully", 
    ...
    public ApiResponse<SellerDto> updateSeller(
            ...
            @RequestBody SellerDto sellerDto,
            @AuthenticationPrincipal UserDetails userDetails) {
        return new ApiResponse<>("Seller updated successfully", 
