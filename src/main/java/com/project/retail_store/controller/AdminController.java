...
public class AdminController {
    ...
    public ApiResponse<SellerDto> updateSeller(@PathVariable Long sellerId, @RequestBody SellerDto sellerDto) {
        return new ApiResponse<>("Seller updated", sellerService.updateSeller(sellerId, sellerDto, "Admin"));
    }
    ...
    public ApiResponse<ProductCategoryDto> updateCategory(@PathVariable Long categoryId, @RequestBody ProductCategoryDto categoryDto) {
        return new ApiResponse<>("Category updated", categoryService.updateCategory(categoryId, categoryDto));
    }
    ...
    public ApiResponse<ProductDto> updateProduct(@PathVariable Long productId, @RequestBody ProductDto productDto) {
        return new ApiResponse<>("Product updated", productService.updateProduct(productId, productDto));
    }
