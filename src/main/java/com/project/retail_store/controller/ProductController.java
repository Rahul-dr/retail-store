...
@RestController
@RequestMapping("/api/admin/product-management")
...
public class ProductController {
  ...
  public ApiResponse<ProductDto> updateProduct(
    ...
    return new ApiResponse<>(
        "Product updated successfully", productService.updateProduct(productId, productDto));
  }
  ...
  public ApiResponse<String> disableProduct(@PathVariable Long productId) {
    ...
    return new ApiResponse<>(
        "Product disabled successfully", "Product with ID " + productId + " has been disabled.");
  }
}
