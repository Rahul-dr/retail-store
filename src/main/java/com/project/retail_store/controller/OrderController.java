...
public class OrderController {
    ...
    public ApiResponse<List<OrderDTO>> getCustomerOrders(@PathVariable Long customerId) {
        return new ApiResponse<>("Orders retrieved successfully", orderService.getCustomerOrders(customerId));
    }
    ...
    public ApiResponse<OrderDTO> getOrderDetails(
        ...
        return new ApiResponse<>("Order details retrieved successfully", orderService.getOrderDetails(customerId, orderId));
    }
}