...
public class CustomerController {
  ...
  public ApiResponse<CustomerDto> getProfile(@PathVariable Long customerId) {
    return new ApiResponse<>(
        "Profile retrieved successfully", customerService.getCustomerProfile(customerId));
  }
  ...
  public ApiResponse<CustomerDto> updateProfile(
    ...
    return new ApiResponse<>(
        ...
        customerService.updateCustomerProfile(customerId, customerDto));
  }
  ...
  public ApiResponse<String> disableCustomer(@PathVariable Long customerId) {
    ...
    return new ApiResponse<>(
        "Customer disabled successfully", "Customer with ID " + customerId + " has been disabled.");
  }
}
