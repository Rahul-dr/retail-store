...
public class GlobalExceptionHandler {
    ...
    public @ResponseBody ApiResponse<Void> handleException(Exception ex) {
        String errorMsg = "Internal Server Error: " +
                (ex.getLocalizedMessage() == null ? "Unexpected error occurred" : ex.getLocalizedMessage());
    ...
    public @ResponseBody ApiResponse<Void> handleMethodNotAllowedException(HttpRequestMethodNotSupportedException ex) {
    ...
    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    public @ResponseBody ApiResponse<Void> handleMissingServletRequestParameterException(MissingServletRequestParameterException ex) {
    ...
    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    public @ResponseBody ApiResponse<Void> handleValidationException(MethodArgumentNotValidException ex) {
